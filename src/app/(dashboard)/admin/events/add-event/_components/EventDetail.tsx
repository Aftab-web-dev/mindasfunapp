...
function EventDetail({ setTabIndex, data }: { setTabIndex: any; data: any }) {
  return (
    <div className='w-full bg-white rounded-xl shadow p-6 mt-[1.7rem] ml-4'>
      ...
      <div className='mb-2 flex justify-between items-center'>
        ...
        <button className='text-indigo-500 text-[15px] bg-transparent cursor-pointer' onClick={() => setTabIndex(1)}>
          Edit
        </button>
      </div>
      <div className='text-gray-500 text-sm'>
