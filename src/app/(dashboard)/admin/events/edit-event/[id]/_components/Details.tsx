  ...
  return (
    <div className='bg-white rounded-xl shadow p-6 w-full mt-2'>
      <div className='flex justify-between items-center mb-4'>
        ...
        <button className='text-indigo-500 text-[15px] bg-transparent cursor-pointer' onClick={() => setTabIndex(2)}>
          Edit
        </button>
      </div>
      ...
      <div className='flex justify-between items-center'>
        ...
        />
        <div className='flex flex-col items-end mt-6 gap-1 text-sm'>
          <div>
