    ...
    profile: {
      ...
      projectTable: [
        ...
        },
        {
          ...
          avatarGroup: ['/images/avatars/7.png', '/images/avatars/8.png', '/images/avatars/profile.png'],
          status: 36
        },
        {
          id: 6,
    ...
    teams: [
      {
        ...
        avatar: '/images/logos/react-bg.png',
        avatarGroup: [
          { avatar: '/images/avatars/profile.png', name: 'Vinnie Mostowy' },
      ...
      },
      {
        ...
        avatarGroup: [
          { avatar: '/images/avatars/profile.png', name: 'Jimmy Ressula' },
      ...
      },
      {
        ...
        avatarGroup: [
          { avatar: '/images/avatars/profile.png', name: 'Kim Merchent' },
      ...
      },
      {
        ...
        avatar: '/images/logos/figma-bg.png',
        avatarGroup: [
          { avatar: '/images/avatars/profile.png', name: 'Andrew Mostowy' },
    ...
    projects: [
      ...
      },
      {
        ...
        avatarGroup: [
          ...
          { avatar: '/images/avatars/profile.png', name: 'Danny Paul' }
        ]
      },
      {
        comments: 120,
      ...
      },
      {
        ...
        avatarGroup: [
          ...
          { avatar: '/images/avatars/profile.png', name: 'Katy Turner' },
